...
// ____________________________________________The details pertaining to each item/product defined in the html page...
    ...
    function addProduct1() {
		...
		var productAdded = $('<li class="product"> <div class="product-image"><a href="#0"><img src="css/assets/products/tshirt.png" height="50" width="50" alt="placeholder"></a></div><div class="product-details"><h3><a href="#0">Black Shirt</a></h3><span class="price">$8.00</span><div class="actions"><a href="#0" class="delete-item">Delete</a><div class="quantity"><label for="cd-product-'+ productId +'">Qty</label><span class="select"><select id="cd-product-'+ productId +'" name="quantity"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></span></div></div></div></li>');
	...
	function addProduct2() {
        ...
        //replace productId, productName, price and url with your custom product info (incase you want to test)
		productId = productId + 1;
		var productAdded = $('<li class="product"> <div class="product-image"><a href="#0"><img src="css/assets/products/pants.png" height="50" width="50" alt="placeholder"></a></div><div class="product-details"><h3><a href="#0">Brown Pants</a></h3><span class="price">$30.00</span><div class="actions"><a href="#0" class="delete-item">Delete</a><div class="quantity"><label for="cd-product-'+ productId +'">Qty</label><span class="select"><select id="cd-product-'+ productId +'" name="quantity"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></span></div></div></div></li>');
		cartList.prepend(productAdded);
	}
	...
	function addProduct3() {
        ...
        //replace productId, productName, price and url with your custom product info (incase you want to test)
		productId = productId + 1;
		var productAdded = $('<li class="product"> <div class="product-image"><a href="#0"><img src="css/assets/products/backpack.png" height="50" width="50" alt="placeholder"></a></div><div class="product-details"><h3><a href="#0">Grey Bag</a></h3><span class="price">$60.00.00</span><div class="actions"><a href="#0" class="delete-item">Delete</a><div class="quantity"><label for="cd-product-'+ productId +'">Qty</label><span class="select"><select id="cd-product-'+ productId +'" name="quantity"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></span></div></div></div></li>');
		cartList.prepend(productAdded);
	}
	...
	function addProduct6() {
        ...
        //replace productId, productName, price and url with your custom product info (incase you want to test)
		productId = productId + 1;
		var productAdded = $('<li class="product"> <div class="product-image"><a href="#0"><img src="css/assets/products/tshirt_ladies.png" height="50" width="50" alt="placeholder"></a></div><div class="product-details"><h3><a href="#0">Female Top Indigo</a></h3><span class="price">$20.00</span><div class="actions"><a href="#0" class="delete-item">Delete</a><div class="quantity"><label for="cd-product-'+ productId +'">Qty</label><span class="select"><select id="cd-product-'+ productId +'" name="quantity"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></span></div></div></div></li>');
		cartList.prepend(productAdded);
    }
